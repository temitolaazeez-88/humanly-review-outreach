/* HumanlyReview shared frontend helpers — v7.1.0 (hybrid PDF pricing). */
...
const HR_STORAGE = Object.freeze({
  ...
  PUBLIC_CONFIG_CACHE: 'hr_public_config_cache_v3'
});
