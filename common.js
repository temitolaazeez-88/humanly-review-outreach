/* HumanlyReview shared frontend helpers — v9.1.1. */
...
const HR_STORAGE = Object.freeze({
  ...
  PUBLIC_CONFIG_CACHE: 'hr_public_config_cache_v4'
});
...
const HR_READ_ACTIONS=new Set(['health','getPublicConfig','getPublicPosts','getPublicPost','checkSession','matchPlan','getOrderStatus','getCustomRequestStatus','getDelivery','getPaidOrderRecovery','getDownloadChunk']);
